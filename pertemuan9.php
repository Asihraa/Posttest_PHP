<html>
    ...
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
        ...
        <body>
            <h2>Post Test PHP Asih Rahmawati</h2>
            ...
            <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]);?>" method="POST">
                ...
                <input type="radio" name="prodi" value="ASP" <?php echo (isset($_POST['prodi']) && $_POST['prodi'] == 'Akuntansi Sektor Publik') ? 'checked' : ''; ?>>Akuntansi Sektor Publik
                <input type="radio" name="prodi" value="Tekom" <?php echo (isset($_POST['prodi']) && $_POST['prodi'] == 'Teknik Komputer') ? 'checked' : ''; ?>>Teknik Komputer
                ...
                <input type="radio" name="prodi" value="DKV" <?php echo (isset($_POST['prodi']) && $_POST['prodi'] == 'Desain Komunikasi Visual') ? 'checked' : ''; ?>>Desain Komunikasi Visual
